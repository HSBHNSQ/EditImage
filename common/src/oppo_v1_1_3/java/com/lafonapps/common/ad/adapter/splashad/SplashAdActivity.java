...
public class SplashAdActivity extends Activity implements SplashAd {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        MobAdManager.getInstance(Common.getSharedApplication()).init(CommonConfig.sharedCommonConfig.appID4OPPO, new IInitListener() {
            @Override
...
//            loadAndDisplay();
    ...
    public void loadAndDisplay() {
        if (CommonConfig.sharedCommonConfig.shouldShowSplashAd) {
            splashAd = new com.oppo.mobad.ad.SplashAd(this, container, CommonConfig.sharedCommonConfig.splashAdUnitID4OPPO, new ISplashAdListener() {
                @Override
